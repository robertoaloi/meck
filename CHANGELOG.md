...
- Reload modules that were loaded before mocking ([\#228](https://github.com/eproxus/meck/pull/228)) ([zsoci](https://github.com/zsoci))

### Fixed

- Fix misleading not_mocked errors when unloading a mock ([\#231](https://github.com/eproxus/meck/pull/231)) ([aronisstav](https://github.com/aronisstav))
- Fix calling mocked modules from expectations fun ([\#232](https://github.com/eproxus/meck/pull/232)) ([pergu](https://github.com/pergu))
- Fix spec of meck:raise/2
- Increase meck_proc stop timeout to infinity to prevent confusing errors
- Code coverage leak from temporary backup modules in Erlang.mk ([\#246](https://github.com/eproxus/meck/pull/246)) ([andrei-mihaila](https://github.com/andrei-mihaila))
...
- Fix a Dialyzer warning on OTP 24 ([\#223](https://github.com/eproxus/meck/pull/223)) ([paulo-ferraz-oliveira](https://github.com/paulo-ferraz-oliveira))

## [0.9.1] - 2021-02-17

### Fixed

- Module references in type specs were not included when renaming modules ([\#206](https://github.com/eproxus/meck/issues/206)) ([jesperes](https://github.com/jesperes))
- The passthrough clause was not always the last clause in an expect with multiple clauses ([\#216](https://github.com/eproxus/meck/pull/216)) ([zsoci](https://github.com/zsoci))
...
- Add a new function `mocked/0` that returns which modules are currently mocked ([\#210](https://github.com/eproxus/meck/pull/210)) ([fcristovao](https://github.com/fcristovao))

### Changed

- Validate the options being passed to meck:new ([\#204](https://github.com/eproxus/meck/pull/204)) ([FrankBro](https://github.com/FrankBro))

### Fixed

- Do not attempt to generate dependencies when mocking ([9b3ce75](https://github.com/eproxus/meck/commit/9b3ce754bd69e84127f82d482b8b23b22f7bf866)) ([jesperes](https://github.com/jesperes))
- Add compiler application to dependencies ([\#209](https://github.com/eproxus/meck/pull/209)) ([jbreindel](https://github.com/jbreindel))
- meck:ret_spec() opaqueness violates documented usage patterns ([\#212](https://github.com/eproxus/meck/issues/212)) ([jesperes](https://github.com/jesperes))
...
- Fix typo ([\#143](https://github.om/eproxus/meck/pull/143)) ([derek121](https://github.com/derek121))
